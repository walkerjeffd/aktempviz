...
list(
  ...
  tar_target(nps_datasets, collect_nps_datasets(nps_metrics), error = "null"),
  tar_target(nps_stations, transform_nps_datasets(nps_datasets), error = "null"),
  tar_target(nps_raw_data, collect_nps_raw_data(nps_datasets), error = "null"),
